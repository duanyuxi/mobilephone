...
<section class="productList">
  <ul>
   <li>
    <a href="../goods/product.html" class="goodsPic">
     <img src="/Public/upload/goods001.jpg"/>
    </a>
    <div class="goodsInfor">
     <h2>
      <a href="../goods/product.html">新鲜生菜两斤装特惠</a>
     </h2>
     <p>
      <del>5.90</del>
     </p>
   ...
   <li>
    ...
    <div class="goodsInfor">
     <h2>
      <a href="../goods/product.html">红萝卜3斤装</a>
     </h2>
     <p>
      <del>12.90</del>
     </p>
   ...
   <li>
    ...
    <div class="goodsInfor">
     <h2>
      <a href="../goods/product.html">西红柿5斤装</a>
     </h2>
     <p>
      <del>9.90</del>
     </p>
