...
<form class='form' action="<?php echo U('login/VerifyServlet');?>" method="post">
<ul class="formarea">
 <li>
 ...
 <li class="liLink lg_liLink">
  ...
  <span><a href="<?php echo U('login/register');?>">新用户注册</a></span>
  <span><a href="<?php echo U('login/find_pwd');?>">忘记密码?</a></span>
 </li>
 <li>
...
<script>
    ...
    $.ajax({
        ...
        url: "<?php echo U('login/StartServlet');?>?" + (new Date()).getTime(), // 加随机数防止缓存
        type: "get",
        dataType: "json",
